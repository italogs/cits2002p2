...
uniqfs:        uniqfs.o put.o globals.o create.o md5digest.o
	cc -o uniqfs uniqfs.o globals.o put.o create.o md5digest.o -lssl -lcrypto
...
clean:
	rm -f uniqfs.o globals.o create.o md5digest.o put.o
